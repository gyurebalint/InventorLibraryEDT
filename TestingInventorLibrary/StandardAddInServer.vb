...
Namespace TestingInventorLibrary
    <ProgIdAttribute("TestingInventorLibrary.StandardAddInServer"), _
...
#Region "ApplicationAddInServer Members"
        ...
        Public Sub Activate(ByVal addInSiteObject As Inventor.ApplicationAddInSite, ByVal firstTime As Boolean) Implements Inventor.ApplicationAddInServer.Activate
            Try
                ...
                m_sampleButton = Utilities.CreateButtonDefinition("Command" & vbCr & "Name", "TestingEDT", "", "ButtonResources\SampleButton")
            ...
            Catch ex As Exception
                MsgBox("Unexpected failure in the activation of the add-in ""TestingInventorLibrary""" & vbCrLf & vbCrLf & ex.Message)
            End Try
        End Sub
...
Public Module Globals
    ...
    Public Const g_simpleAddInClientID As String = "d43c90c1-41de-4b52-9a66-607d1d13be6e"
